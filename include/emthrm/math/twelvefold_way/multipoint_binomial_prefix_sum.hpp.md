...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"include/emthrm/math/twelvefold_way/multipoint_binomial_prefix_sum.hpp\"\
    \n\n\n\n#include <algorithm>\n#include <cassert>\n#include <vector>\n\n#line 1\
    ...
    \ 5 \"include/emthrm/misc/mo.hpp\"\n#include <cmath>\n#include <numeric>\n#line\
    \ 8 \"include/emthrm/misc/mo.hpp\"\n\nnamespace emthrm {\n\ntemplate <typename\
    ...
    \ = sum;\n  }\n  return ans;\n}\n\n}  // namespace emthrm\n\n\n"
  code: "#ifndef EMTHRM_MATH_TWELVEFOLD_WAY_MULTIPOINT_BINOMIAL_PREFIX_SUM_HPP_\n\
    #define EMTHRM_MATH_TWELVEFOLD_WAY_MULTIPOINT_BINOMIAL_PREFIX_SUM_HPP_\n\n#include\
    \ <algorithm>\n#include <cassert>\n#include <vector>\n\n#include \"emthrm/math/modint.hpp\"\
    \n#include \"emthrm/misc/mo.hpp\"\n\nnamespace emthrm {\n\ntemplate <unsigned\
    \ int T>\nstd::vector<MInt<T>> multipoint_binomial_prefix_sum(\n    const std::vector<int>&\
    \ ns, const std::vector<int>& ms) {\n  using ModInt = MInt<T>;\n  assert(ns.size()\
