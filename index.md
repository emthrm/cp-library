...
data:
  libraryCategories:
  - name: include/emthrm/data_structure
    pages:
  ...
  - name: include/emthrm/dynamic_programming
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: include/emthrm/graph/flow/matching
    ...
    - icon: ':question:'
      ...
      title: "\u4E8C\u90E8\u30B0\u30E9\u30D5\u306E\u91CD\u307F\u4ED8\u304D\u6700\u5927\
        \u30DE\u30C3\u30C1\u30F3\u30B0"
  - name: include/emthrm/graph/flow/maximum_flow
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: include/emthrm/graph/flow/minimum_cost_flow
    pages:
    - icon: ':heavy_check_mark:'
    ...
    - icon: ':question:'
      ...
      title: "\u6700\u5C0F\u8CBB\u7528 $s$-$t$-\u30D5\u30ED\u30FC \u6700\u77ED\u8DEF\
        \u53CD\u5FA9\u6CD5\u7248"
  - name: include/emthrm/graph/shortest_path
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: include/emthrm/math/twelvefold_way
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: "\u30D1\u30B9\u30AB\u30EB\u306E\u4E09\u89D2\u5F62"
  - name: include/emthrm/math/twelvefold_way/stirling_number
    pages:
    - icon: ':warning:'
