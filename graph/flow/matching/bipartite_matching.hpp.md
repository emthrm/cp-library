...
data:
  ...
  code: "/**\r\n * @brief \u4E8C\u90E8\u30B0\u30E9\u30D5\u306E\u6700\u5927\u30DE\u30C3\
    ...
    \ match;\r\n\r\n  BipartiteMatching(int n) : n(n), graph(n), match(n, -1), used(n,\
    \ -1), alive(n, true) {}\r\n\r\n  void add_edge(int u, int v) {\r\n    graph[u].emplace_back(v);\r\
    ...
    \ != -1) match[match[ver]] = -1;\r\n    match[ver] = -1;\r\n    ++timestamp;\r\
    \n    dfs(ver);\r\n    return match[ver];\r\n  }\r\n\r\n  void fix(int ver) {\r\
    \n    alive[ver] = false;\r\n    if (match[ver] != -1) alive[match[ver]] = false;\r\
    ...
    \ alive;\r\n\r\n  bool dfs(int ver) {\r\n    used[ver] = timestamp;\r\n    for\
    \ (int e : graph[ver]) {\r\n      if (!alive[e]) continue;\r\n      int tmp =\
    \ match[e];\r\n      if (tmp == -1 || (used[tmp] < timestamp && dfs(tmp))) {\r\
    \n        match[ver] = e;\r\n        match[e] = ver;\r\n        return true;\r\
    \n      }\r\n    }\r\n    return false;\r\n  }\r\n};\r\n"
  dependsOn: []
...
documentation_of: graph/flow/matching/bipartite_matching.hpp
layout: document
redirect_from:
- /library/graph/flow/matching/bipartite_matching.hpp
- /library/graph/flow/matching/bipartite_matching.hpp.html
title: "\u4E8C\u90E8\u30B0\u30E9\u30D5\u306E\u6700\u5927\u30DE\u30C3\u30C1\u30F3\u30B0"
---
### 最大マッチング
