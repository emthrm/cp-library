...
data:
  ...
  bundledCode: "#line 1 \"test/math/formal_power_series/faulhaber_by_fps.test.cpp\"\
    \n/*\n * @title \u6570\u5B66/\u5F62\u5F0F\u7684\u51AA\u7D1A\u6570/\u30D5\u30A1\
    \u30A6\u30EB\u30CF\u30FC\u30D0\u30FC\u306E\u516C\u5F0F \u5F62\u5F0F\u7684\u51AA\
    ...
    \ std::llround(x[i].im)\n             + std::llround(x[i].re);\n  }\n  return\
    \ res;\n}\n\n}  // namespace emthrm\n\n\n#line 1 \"include/emthrm/math/formal_power_series/faulhaber_by_fps.hpp\"\
    \n\n\n\n#line 6 \"include/emthrm/math/formal_power_series/faulhaber_by_fps.hpp\"\
    ...
    \n\nnamespace emthrm {\n\ntemplate <int T>\nMInt<T> faulhaber_by_fps(const long\
    \ long n, const int k) {\n  using ModInt = MInt<T>;\n  if (n <= 1) [[unlikely]]\
    \ return 0;\n  if (k == 0) [[unlikely]] return n - 1;\n  ModInt::init(k + 1);\n\
    \  const std::vector<ModInt> bernoulli = bernoulli_number<ModInt>(k);\n  ModInt\
    \ res = 0, p = 1;\n  for (int i = k; i >= 0; --i) {\n    p *= n;\n    res += ModInt::nCk(k\
    \ + 1, i) * bernoulli[i] * p;\n  }\n  return res / (k + 1);\n}\n\n}  // namespace\
    \ emthrm\n\n\n#line 14 \"test/math/formal_power_series/faulhaber_by_fps.test.cpp\"\
