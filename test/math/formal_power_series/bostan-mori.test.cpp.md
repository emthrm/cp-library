...
data:
  ...
  bundledCode: "#line 1 \"test/math/formal_power_series/bostan-mori.test.cpp\"\n/*\n\
    \ * @title \u6570\u5B66/\u5F62\u5F0F\u7684\u51AA\u7D1A\u6570/Bostan\u2013Mori\
    ...
    \ a(d - 1), c(d);\n  c[0] = 1;\n  for (int i = 0; i < d; ++i) {\n    std::cin\
    \ >> a[i];\n  }\n  for (int i = 1; i <= d; ++i) {\n    std::cin >> c[i];\n   \
    \ c[i] = -c[i];\n  }\n  std::cout << emthrm::nth_term_of_linear_recurrence_sequence(a,\
    \ c, k) << '\\n';\n  return 0;\n}\n"
  code: "/*\n * @title \u6570\u5B66/\u5F62\u5F0F\u7684\u51AA\u7D1A\u6570/Bostan\u2013\
    Mori \u306E\u30A2\u30EB\u30B4\u30EA\u30BA\u30E0\n *\n * verification-helper: PROBLEM\
    \ https://judge.yosupo.jp/problem/kth_term_of_linearly_recurrent_sequence\n */\n\
