...
data:
  ...
  bundledCode: "#line 1 \"test/math/formal_power_series/product_of_polynomial_sequence.test.cpp\"\
    \n/*\n * @title \u6570\u5B66/\u5F62\u5F0F\u7684\u51AA\u7D1A\u6570/\u591A\u9805\
    \u5F0F\u5217\u306E\u76F8\u4E57\n *\n * verification-helper: PROBLEM https://judge.yosupo.jp/problem/product_of_polynomial_sequence\n\
    \ */\n\n#include <cassert>\n#include <iostream>\n#include <vector>\n\n#line 1\
    \ \"include/emthrm/math/convolution/number_theoretic_transform.hpp\"\n\n\n\n#include\
    \ <algorithm>\n#include <bit>\n#line 7 \"include/emthrm/math/convolution/number_theoretic_transform.hpp\"\
    ...
    \n\n\n\n#include <queue>\n#line 6 \"include/emthrm/math/formal_power_series/product_of_polynomial_sequence.hpp\"\
    \n\nnamespace emthrm {\n\ntemplate <template <typename> class C, typename T>\n\
    C<T> product_of_polynomial_sequence(std::vector<C<T>> a) {\n  const int n = a.size();\n\
    \  if (n == 0) [[unlikely]] return C<T>{1};\n  for (int i = 0; i < n; ++i) {\n\
    \    a[i].shrink();\n  }\n  const auto compare = [&a](const int l, const int r)\
    ...
    \    que.emplace(j);\n  }\n  return a[que.top()];\n}\n\n}  // namespace emthrm\n\
    \n\n#line 15 \"test/math/formal_power_series/product_of_polynomial_sequence.test.cpp\"\
