...
data:
  ...
  attributes:
    ...
    document_title: "\u6570\u5B66/\u7573\u307F\u8FBC\u307F/subset convolution"
    links:
    - https://judge.yosupo.jp/problem/subset_convolution
  bundledCode: "#line 1 \"test/math/convolution/subset_convolution.test.cpp\"\n/*\n\
    ...
    \ c = emthrm::subset_convolution<kMaxN>(a, b);\n  for (int i = 0; i < (1 << n);\
    \ ++i) {\n    std::cout << c[i] << \" \\n\"[i + 1 == (1 << n)];\n  }\n  return\
    \ 0;\n}\n"
  code: "/*\n * @title \u6570\u5B66/\u7573\u307F\u8FBC\u307F/subset convolution\n\
  ...
  verifiedWith: []
documentation_of: test/math/convolution/subset_convolution.test.cpp
layout: document
redirect_from:
- /verify/test/math/convolution/subset_convolution.test.cpp
- /verify/test/math/convolution/subset_convolution.test.cpp.html
title: "\u6570\u5B66/\u7573\u307F\u8FBC\u307F/subset convolution"
---
