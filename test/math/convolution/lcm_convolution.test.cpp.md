...
data:
  ...
  bundledCode: "#line 1 \"test/math/convolution/lcm_convolution.test.cpp\"\n/*\n *\
    ...
    \n\n\n\n#line 5 \"include/emthrm/math/convolution/lcm_convolution.hpp\"\n\nnamespace\
    ...
    }  // namespace emthrm\n\n\n#line 12 \"test/math/convolution/lcm_convolution.test.cpp\"\
    \n\nint main() {\n  using ModInt = emthrm::MInt<998244353>;\n  int n;\n  std::cin\
    \ >> n;\n  std::vector<ModInt> a(n + 1, 0), b(n + 1, 0);\n  for (int i = 1; i\
    \ <= n; ++i) {\n    std::cin >> a[i];\n  }\n  for (int i = 1; i <= n; ++i) {\n\
    \    std::cin >> b[i];\n  }\n  const std::vector<ModInt> c = emthrm::lcm_convolution(a,\
    \ b, n);\n  for (int i = 1; i <= n; ++i) {\n    std::cout << c[i] << \" \\n\"\
    [i == n];\n  }\n  return 0;\n}\n"
  code: "/*\n * @title \u6570\u5B66/\u7573\u307F\u8FBC\u307F/\u6DFB\u3048\u5B57 lcm\
    \ \u3067\u306E\u7573\u307F\u8FBC\u307F\n *\n * verification-helper: PROBLEM https://judge.yosupo.jp/problem/lcm_convolution\n\
