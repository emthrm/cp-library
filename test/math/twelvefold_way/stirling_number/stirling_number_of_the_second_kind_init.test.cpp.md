...
data:
  ...
  bundledCode: "#line 1 \"test/math/twelvefold_way/stirling_number/stirling_number_of_the_second_kind_init.test.cpp\"\
  ...
  code: "/*\n * @title \u6570\u5B66/\u5199\u50CF12\u76F8/\u30B9\u30BF\u30FC\u30EA\u30F3\
    ...
    emthrm/math/twelvefold_way/stirling_number/stirling_number_of_the_second_kind_init.hpp\"\
    \n\nint main() {\n  using ModInt = emthrm::MInt<1000000007>;\n  int n, k;\n  std::cin\
    \ >> n >> k;\n  const ModInt ans =\n      emthrm::stirling_number_of_the_second_kind_init<ModInt>(n,\
    \ k)[n][k];\n  std::cout << ans << '\\n';\n  return 0;\n}\n"
  dependsOn:
