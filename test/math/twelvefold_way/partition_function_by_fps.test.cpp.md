...
data:
  ...
  bundledCode: "#line 1 \"test/math/twelvefold_way/partition_function_by_fps.test.cpp\"\
    ...
    \  }\n};\n\n}  // namespace emthrm\n\n\n#line 1 \"include/emthrm/math/twelvefold_way/partition_function_by_fps.hpp\"\
    \n\n\n\n#line 5 \"include/emthrm/math/twelvefold_way/partition_function_by_fps.hpp\"\
    ...
    \ // namespace emthrm\n\n\n#line 14 \"test/math/twelvefold_way/partition_function_by_fps.test.cpp\"\
    ...
    \ b);\n      });\n  int n;\n  std::cin >> n;\n  const std::vector<ModInt> p =\
    \ emthrm::partition_function_by_fps<ModInt>(n);\n  for (int i = 0; i <= n; ++i)\
    \ {\n    std::cout << p[i] << \" \\n\"[i == n];\n  }\n  return 0;\n}\n"
  code: "/*\n * @title \u6570\u5B66/\u5199\u50CF12\u76F8/\u5206\u5272\u6570 $n = m$\
    \ \u7248\n *\n * verification-helper: PROBLEM https://judge.yosupo.jp/problem/partition_function\n\
