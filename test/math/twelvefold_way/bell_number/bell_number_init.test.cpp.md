...
data:
  ...
  bundledCode: "#line 1 \"test/math/twelvefold_way/bell_number/bell_number_init.test.cpp\"\
    ...
    }  // namespace emthrm\n\n\n#line 1 \"include/emthrm/math/twelvefold_way/bell_number/bell_number_init.hpp\"\
    \n\n\n\n#include <numeric>\n#line 6 \"include/emthrm/math/twelvefold_way/bell_number/bell_number_init.hpp\"\
  ...
  code: "/*\n * @title \u6570\u5B66/\u5199\u50CF12\u76F8/\u30D9\u30EB\u6570/\u30D9\
    ...
    emthrm/math/twelvefold_way/bell_number/bell_number_init.hpp\"\n\nint main() {\n\
    \  using ModInt = emthrm::MInt<1000000007>;\n  int n, k;\n  std::cin >> n >> k;\n\
    \  std::cout << emthrm::bell_number_init<ModInt>(n, k)[n][k] << '\\n';\n  return\
    \ 0;\n}\n"
  dependsOn:
