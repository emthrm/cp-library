...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.22.test.cpp\"\n/*\n * @title \u8A08\
    ...
    \ <algorithm>\n#include <cassert>\n#include <cmath>\n#include <compare>\n#line\
    \ 9 \"include/emthrm/geometry/geometry.hpp\"\n#include <iterator>\n#include <limits>\n\
    #include <numbers>\n#include <numeric>\n#line 14 \"include/emthrm/geometry/geometry.hpp\"\
    \n#include <utility>\n#include <vector>\n\nnamespace emthrm {\n\nnamespace geometry\
    ...
    }\n\n}  // namespace geometry\n\n}  // namespace emthrm\n\n\n#line 13 \"test/geometry/geometry.22.test.cpp\"\
  ...
  code: "/*\n * @title \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    ...
    \ >> n;\n  emthrm::geometry::Polygon g(n);\n  for (int i = 0; i < n; ++i) {\n\
    \    std::cin >> g[i];\n  }\n  const std::tuple<emthrm::geometry::Point, emthrm::geometry::Point>\
