...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/smallest_enclosing_circle.test.cpp\"\n/*\n\
    ...
    \ 0);\n}\n\nReal degree_to_radian(const Real d) { return d * std::numbers::pi\
    ...
    \ res < 0 ? res + std::numbers::pi * 2 : res;\n  }\n\n  Real norm() const { return\
    ...
    }\n\n}  // namespace geometry\n\n}  // namespace emthrm\n\n\n#line 1 \"include/emthrm/geometry/smallest_enclosing_circle.hpp\"\
    \n\n\n\n#line 5 \"include/emthrm/geometry/smallest_enclosing_circle.hpp\"\n#include\
    \ <random>\n#line 8 \"include/emthrm/geometry/smallest_enclosing_circle.hpp\"\n\
    \n#line 10 \"include/emthrm/geometry/smallest_enclosing_circle.hpp\"\n\nnamespace\
    \ emthrm {\n\nnamespace geometry {\n\nCircle smallest_enclosing_circle(std::vector<Point>\
    \ ps) {\n  const int n = ps.size();\n  if (n == 1) [[unlikely]] return Circle(ps.front(),\
    \ 0);\n  std::shuffle(ps.begin(), ps.end(), std::mt19937_64(std::random_device\
    \ {} ()));\n  const auto get_circle = [](const Point& p1, const Point& p2) ->\
    \ Circle {\n    return Circle((p1 + p2) * 0.5, distance(p1, p2) * 0.5);\n  };\n\
    \  Circle res = get_circle(ps[0], ps[1]);\n  const auto is_in = [&res](const Point&\
    ...
    \            + ps[i] * c * (a + b - c)) / (4 * s * s);\n        res = Circle(p,\
    \ distance(ps[k], p));\n      }\n    }\n  }\n  return res;\n}\n\n}  // namespace\
    \ geometry\n\n}  // namespace emthrm\n\n\n#line 14 \"test/geometry/smallest_enclosing_circle.test.cpp\"\
