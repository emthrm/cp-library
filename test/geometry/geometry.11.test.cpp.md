...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.11.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (2\u5186\u306E\u4EA4\u70B9\
    ...
    \ radian_to_degree(Real r) { return r * 180 / PI; }\r\n\r\nstruct Point {\r\n\
    ...
    \n}\r\n}  // geometry\r\n#line 12 \"test/geometry/geometry.11.test.cpp\"\n\r\n\
    int main() {\r\n  geometry::Point c1_o, c2_o;\r\n  double c1r, c2r;\r\n  std::cin\
    \ >> c1_o >> c1r >> c2_o >> c2r;\r\n  std::vector<geometry::Point> ans = geometry::intersection(geometry::Circle(c1_o,\
    \ c1r), geometry::Circle(c2_o, c2r));\r\n  std::sort(ans.begin(), ans.end());\r\
  ...
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    ...
    \ = geometry::intersection(geometry::Circle(c1_o, c1r), geometry::Circle(c2_o,\
    \ c2r));\r\n  std::sort(ans.begin(), ans.end());\r\n  if (ans.size() == 1) {\r\
    \n    std::cout << std::fixed << std::setprecision(7) << ans[0].x << ' ' << ans[0].y\
    \ << ' ' << ans[0].x << ' ' << ans[0].y << '\\n';\r\n  } else if (ans.size() ==\
    \ 2) {\r\n    for (int i = 0; i < 2; ++i) {\r\n      std::cout << std::fixed <<\
    \ std::setprecision(7) << ans[i].x << ' ' << ans[i].y << \" \\n\"[i + 1 == 2];\r\
    \n    }\r\n  }\r\n  return 0;\r\n}\r\n"
  dependsOn:
  - geometry/geometry.hpp
