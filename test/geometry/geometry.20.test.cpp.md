...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.20.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (\u51F8\u5305)\r\n */\r\
    ...
    \n}\r\n}  // geometry\r\n#line 12 \"test/geometry/geometry.20.test.cpp\"\n\r\n\
    ...
    \ ++i) ps.emplace_back(convex_hull[i], i);\r\n  std::sort(ps.begin(), ps.end(),\
    \ [](const std::pair<geometry::Point, int> &a, const std::pair<geometry::Point,\
    \ int> &b) -> bool {\r\n    const geometry::Point &a_p = a.first, &b_p = b.first;\r\
    \n    int sign = geometry::sgn(b_p.y - a_p.y);\r\n    return sign == 0 ? geometry::sgn(b_p.x\
    \ - a_p.x) == 1 : sign == 1;\r\n  });\r\n  std::rotate(convex_hull.begin(), convex_hull.begin()\
    \ + ps.front().second, convex_hull.end());\r\n  std::cout << sz << '\\n';\r\n\
    \  for (const geometry::Point &e : convex_hull) {\r\n    std::cout << static_cast<int>(std::round(e.x))\
