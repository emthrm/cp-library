...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.12.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (2\u7DDA\u5206\u306E\u8DDD\
    ...
    \n}\r\n}  // geometry\r\n#line 10 \"test/geometry/geometry.12.test.cpp\"\n\r\n\
    int main() {\r\n  int q;\r\n  std::cin >> q;\r\n  while (q--) {\r\n    geometry::Point\
    \ p0, p1, p2, p3;\r\n    std::cin >> p0 >> p1 >> p2 >> p3;\r\n    std::cout <<\
    \ std::fixed << std::setprecision(9) << geometry::distance(geometry::Segment(p0,\
  ...
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    ...
    \ << geometry::distance(geometry::Segment(p0, p1), geometry::Segment(p2, p3))\
    \ << '\\n';\r\n  }\r\n  return 0;\r\n}\r\n"
  dependsOn:
