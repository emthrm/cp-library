...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.16.test.cpp\"\n/*\r\n * @brief \u8A08\
    ...
    \n}\r\n}  // geometry\r\n#line 10 \"test/geometry/geometry.16.test.cpp\"\n\r\n\
    int main() {\r\n  geometry::Point c1_o, c2_o;\r\n  double c1r, c2r;\r\n  std::cin\
    \ >> c1_o >> c1r >> c2_o >> c2r;\r\n  std::cout << std::fixed << std::setprecision(7)\
    \ << geometry::intersection_area(geometry::Circle(c1_o, c1r), geometry::Circle(c2_o,\
    \ c2r)) << '\\n';\r\n  return 0;\r\n}\r\n"
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    \ (2\u5186\u306E\u5171\u901A\u90E8\u5206\u306E\u9762\u7A4D)\r\n */\r\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_I\"\
    ...
    \n  std::cout << std::fixed << std::setprecision(7) << geometry::intersection_area(geometry::Circle(c1_o,\
