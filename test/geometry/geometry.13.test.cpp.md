...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.13.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (\u63A5\u70B9)\r\n */\r\
    ...
    \n}\r\n}  // geometry\r\n#line 11 \"test/geometry/geometry.13.test.cpp\"\n\r\n\
    int main() {\r\n  geometry::Point p, c_o;\r\n  double r;\r\n  std::cin >> p >>\
    \ c_o >> r;\r\n  std::vector<geometry::Point> ans = geometry::tangency(geometry::Circle(c_o,\
    \ r), p);\r\n  std::sort(ans.begin(), ans.end());\r\n  for (int i = 0; i < 2;\
    \ ++i) std::cout << ans[i].x << ' ' << ans[i].y << '\\n';\r\n  return 0;\r\n}\r\
    \n"
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    \ (\u63A5\u70B9)\r\n */\r\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\
    \r\n#define ERROR \"0.00001\"\r\n\r\n#include <algorithm>\r\n#include <iostream>\r\
