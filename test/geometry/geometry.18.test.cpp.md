...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.18.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (\u591A\u89D2\u5F62\u306E\
    ...
    \n}\r\n}  // geometry\r\n#line 8 \"test/geometry/geometry.18.test.cpp\"\n\r\n\
    int main() {\r\n  int n;\r\n  std::cin >> n;\r\n  geometry::Polygon g(n);\r\n\
    \  for (int i = 0; i < n; ++i) std::cin >> g[i];\r\n  int q;\r\n  std::cin >>\
    \ q;\r\n  while (q--) {\r\n    geometry::Point p;\r\n    std::cin >> p;\r\n  \
    \  std::cout << geometry::is_contained(g, p) << '\\n';\r\n  }\r\n  return 0;\r\
    \n}\r\n"
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    \ (\u591A\u89D2\u5F62\u306E\u5185\u5916\u5224\u5B9A)\r\n */\r\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_C\"\r\n\r\n\
