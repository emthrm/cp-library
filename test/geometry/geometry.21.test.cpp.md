...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.21.test.cpp\"\n/*\r\n * @brief \u8A08\
    \u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66 (\u51F8\u591A\u89D2\u5F62\
    ...
    \n}\r\n}  // geometry\r\n#line 9 \"test/geometry/geometry.21.test.cpp\"\n\r\n\
    int main() {\r\n  int n;\r\n  std::cin >> n;\r\n  geometry::Polygon g(n);\r\n\
    \  for (int i = 0; i < n; ++i) std::cin >> g[i];\r\n  int q;\r\n  std::cin >>\
    \ q;\r\n  while (q--) {\r\n    geometry::Point p1, p2;\r\n    std::cin >> p1 >>\
    \ p2;\r\n    std::cout << geometry::area(geometry::cut_convex(g, geometry::Line(p1,\
    \ p2))) << '\\n';\r\n  }\r\n  return 0;\r\n}\r\n"
  code: "/*\r\n * @brief \u8A08\u7B97\u5E7E\u4F55\u5B66/\u8A08\u7B97\u5E7E\u4F55\u5B66\
    \ (\u51F8\u591A\u89D2\u5F62\u306E\u5207\u65AD)\r\n */\r\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_C\"\
