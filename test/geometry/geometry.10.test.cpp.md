...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geometry.10.test.cpp\"\n/*\n * @brief \u8A08\
    ...
    \ 5 \"geometry/geometry.hpp\"\n#include <functional>\n#line 7 \"geometry/geometry.hpp\"\
    \n#include <iterator>\n#include <limits>\n#include <tuple>\n#include <utility>\n\
    #line 12 \"geometry/geometry.hpp\"\n\nnamespace geometry {\n\nusing Real = double;\n\
    ...
    \ radian_to_degree(const Real r) { return r * 180 / PI; }\n\nstruct Point {\n\
