...
data:
  ...
  bundledCode: "#line 1 \"test/data_structure/range_sum_query_and_range_add_query.test.cpp\"\
    \n/*\n * @title \u30C7\u30FC\u30BF\u69CB\u9020/\u9045\u5EF6\u4F1D\u64AD\u30BB\u30B0\
    \u30E1\u30F3\u30C8\u6728 (range sum query and range add query)\n *\n * verification-helper:\
    \ PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_G\n */\n\
    ...
    \ b * a.len, a.len};\n  }\n};\n\n}  // namespace monoid\n\n}  // namespace emthrm\n\
    \n\n#line 10 \"test/data_structure/range_sum_query_and_range_add_query.test.cpp\"\
