...
data:
  ...
  bundledCode: "#line 1 \"test/data_structure/union-find/weighted_union-find.test.cpp\"\
    ...
    }  // namespace emthrm\n\n\n#line 12 \"test/data_structure/union-find/weighted_union-find.test.cpp\"\
  ...
  code: "/*\n * @title \u30C7\u30FC\u30BF\u69CB\u9020/\u7D20\u96C6\u5408\u30C7\u30FC\
    ...
    \  using ModInt = emthrm::MInt<MOD>;\n  int n, q;\n  std::cin >> n >> q;\n  emthrm::WeightedUnionFind<ModInt>\
    \ union_find(n);\n  while (q--) {\n    int t, u, v;\n    std::cin >> t >> u >>\
    \ v;\n    if (t == 0) {\n      int x;\n      std::cin >> x;\n      if (union_find.is_same(u,\
    \ v)) {\n        std::cout << (union_find.diff(v, u) == x) << '\\n';\n      }\
    \ else {\n        assert(union_find.unite(v, u, x));\n        std::cout << \"\
    1\\n\";\n      }\n    } else if (t == 1) {\n      if (union_find.is_same(u, v))\
    \ {\n        std::cout << union_find.diff(v, u) << '\\n';\n      } else {\n  \
  ...
  requiredBy: []
  timestamp: '2024-07-28 16:20:19+09:00'
