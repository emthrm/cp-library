...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/opt/hostedtoolcache/Python/3.9.1/x64/lib/python3.9/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    \ math/inverse_element/mod_inv_extgcd2.hpp: line 6: #pragma once found in a non-first\
    \ line\n"
  code: "/**\r\n * @brief \u9006\u5143 \u62E1\u5F35 Euclid \u306E\u4E92\u9664\u6CD5\
    \u72482\r\n * @docs docs/math/inverse_element/inverse_element.md\r\n */\r\n\r\n\
    #pragma once\r\n#include <algorithm>\r\n#include \"../ext_gcd.hpp\"\r\n\r\nlong\
    \ long mod_inv_extgcd2(long long a, int mod) {\r\n  a %= mod;\r\n  if (std::__gcd(a,\
    \ static_cast<long long>(mod)) != 1) return -1;\r\n  return (ext_gcd(a, static_cast<long\
    \ long>(mod)).first + mod) % mod;\r\n}\r\n"
  dependsOn:
  - math/ext_gcd.hpp
  ...
  verifiedWith: []
documentation_of: math/inverse_element/mod_inv_extgcd2.hpp
layout: document
redirect_from:
- /library/math/inverse_element/mod_inv_extgcd2.hpp
- /library/math/inverse_element/mod_inv_extgcd2.hpp.html
